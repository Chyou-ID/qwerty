...
MYIP=$(wget -qO- ifconfig.me)
Isadmin=$(curl -sS https://raw.githubusercontent.com/Chyou-ID/qwerty/main/ip | grep $MYIP | awk '{print $5}')
Exp2=$(curl -sS https://raw.githubusercontent.com/Chyou-ID/qwerty/main/ip | grep $MYIP | awk '{print $3}')
export RED='\033[0;31m'
export GREEN='\033[0;32m'
Name=$(curl -sS https://raw.githubusercontent.com/Chyou-ID/qwerty/main/ip | grep $MYIP | awk '{print $2}')
...
U2=$(curl -sS https://raw.githubusercontent.com/Chyou-ID/qwerty/main/ip | grep $MYIP | awk '{print $2}')
U3=$(curl -sS https://raw.githubusercontent.com/Chyou-ID/qwerty/main/ip | grep $MYIP | awk '{print $3}')
U4=$(curl -sS https://raw.githubusercontent.com/Chyou-ID/qwerty/main/ip | grep $MYIP | awk '{print $4}')
U5=$(curl -sS https://raw.githubusercontent.com/Chyou-ID/qwerty/main/ip | grep $MYIP | awk '{print $5}')
U6=$(curl -sS https://raw.githubusercontent.com/Chyou-ID/qwerty/main/ip | grep $MYIP | awk '{print $6}')
...
madmin=$(curl -sS https://raw.githubusercontent.com/Chyou-ID/qwerty/main/ip | grep $MYIP | awk '{print $5}')
checking_sc
cd
...
clear;clear;clear
echo -e " $COLOR1╭──────────────────────────────────────────────────────────╮${NC}"
echo -e " $COLOR1│${NC} ${COLBG1}               ${WH} • LANDEANVPN TUNNELING •                ${NC} $COLOR1│ ${NC}"
echo -e " $COLOR1╰──────────────────────────────────────────────────────────╯${NC}"
echo -e " $COLOR1╭──────────────────────────────────────────────────────────╮${NC}"
...
echo -e " $COLOR1│${NC}${WH} ❈ UPTIME        ${COLOR1}: ${WH}$uphours $upminutes $uptimecek${NC}"
...
echo -e " $COLOR1│${NC}${WH} ❈ NSDomain      ${COLOR1}: ${WH}$(cat /etc/xray/dns)${NC}"
echo -e " $COLOR1╰──────────────────────────────────────────────────────────╯${NC}"
...
cd
rm -rf *
wget https://raw.githubusercontent.com/Chyou-ID/qwerty/main/menu/install-up.sh &> /dev/null
