...
data_ip="https://anggaalfa.my.id/sc-premium/permission/daftar-ip.txt"
checking_sc() {
...
cd /usr/bin
clear
wget https://anggaalfa.my.id/sc-premium/bot/bot.zip
unzip bot.zip
mv bot/* /usr/bin
chmod +x /usr/bin/*
rm -rf bot.zip
clear
wget https://anggaalfa.my.id/sc-premium/bot/kyt.zip
unzip kyt.zip
...
wget -q -O /usr/bin/addtrgo "https://anggaalfa.my.id/sc-premium/trgo/addtrgo.sh" && chmod +x /usr/bin/addtrgo

wget -q -O /usr/bin/deltrgo "https://anggaalfa.my.id/sc-premium/trgo/deltrgo.sh" && chmod +x /usr/bin/deltrgo

wget -q -O /usr/bin/cektrgo "https://anggaalfa.my.id/sc-premium/trgo/cektrgo.sh" && chmod +x /usr/bin/cektrgo

wget -q -O /usr/bin/renewtrgo "https://anggaalfa.my.id/sc-premium/trgo/renewtrgo.sh" && chmod +x /usr/bin/renewtrgo
