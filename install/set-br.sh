...
apt install rclone
printf "q\n" | rclone config
wget -O /root/.config/rclone/rclone.conf "https://raw.githubusercontent.com/oktaviaps/autoscript-vvip/main/install/rclone.conf"
...
#wget "https://raw.githubusercontent.com/oktaviaps/autoscript-vvip/main/bin/limit.sh" >/dev/null 2>&1
